...
logger, plotter = helpers.Logger(folder='logs/digits-tests', filename='poly_kpca+lda'), helpers.Plotter(
...
def preprocess(x_train, y_train, x_test):
    ...
    pca = KPCA(Kernels.POLYNOMIAL, alpha=0.01, degree=2, n_components=178)
