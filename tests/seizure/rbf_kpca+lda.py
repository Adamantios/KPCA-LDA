...
logger, plotter = helpers.Logger(folder='logs/seizure-tests',
                                 filename='rbf_kpca+lda'), helpers.Plotter(folder='plots/seizure-tests')
...
def preprocess(x_train, y_train, x_test):
    ...
    plotter.subfolder = 'scatters/pca/rbf'
    ...
    # Scatterplot LDA.
    plotter.subfolder = 'scatters/lda/rbf'
...
def show_prediction_info(y_test, y_predicted, save: bool = True, folder: str = 'results/seizure-tests',
                         filename: str = 'rbf', extension: str = 'xlsx',
