...
logger, plotter = helpers.Logger(folder='logs/seizure-tests', filename='linear_kpca+lda'), helpers.Plotter(
...
def preprocess(x_train, y_train, x_test):
    ...
    logger.log('\tApplying Principal Component Analysis with params:')
    kpca_pov = 0.95
    pca = KPCA(Kernels.LINEAR, n_components=kpca_pov)
    ...
    plotter.subfolder = 'scatters/pca/linear'
    ...
    # Scatterplot LDA.
    plotter.subfolder = 'scatters/lda/linear'
