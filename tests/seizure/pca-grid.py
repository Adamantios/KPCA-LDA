...
logger, plotter = helpers.Logger(folder='logs/seizure-tests', filename='kpca_grid_search'), helpers.Plotter(
...
def main():
    ...
    # Grid
    pipe = Pipeline(steps=[('quantile_transformer', MinMaxScaler((-1, 1))),
                           ('pca', KernelPCA()),
