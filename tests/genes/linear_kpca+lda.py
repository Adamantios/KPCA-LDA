...
logger, plotter = helpers.Logger(folder='logs/genes-tests', filename='linear_kpca+lda'), helpers.Plotter(
...
def preprocess(x_train, y_train, x_test):
    ...
    pca = KPCA(Kernels.LINEAR, n_components=20531)
